function results = singleGrid_medium(backend,precision)

% singleGrid_medium: Benchmarks Single Grid solver. Reasonably long
% running.
%
% To run, go to the project root directory and type:
% bench.singleGrid_medium Optionally specify backend (cpu_seq, cpu_par,
% gpu_par) and precision (single, double). E.g.:
% bench.singleGrid_medium("cpu_par","single"). Defaults to "cpu_seq" and
% "double".
%
